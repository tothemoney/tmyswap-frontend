import { ChainId, JSBI, Percent, Token, WNATIVE } from '@tmyswap/sdk'
import addresses from '@tmyswap/addresses'
import { BigNumber } from '@ethersproject/bignumber'
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH } from '@tmyswap/tokens'
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [/* FIXME: add tokens */]/* [bscTokens.busd, bscTokens.cake, bscTokens.btcb] */,
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
}
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0xB645Df78049C3D0E1A32C798CEF5967563302385'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.tmyswap.org/products/pancakeswap-exchange/limit-orders'
