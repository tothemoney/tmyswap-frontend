import { ChainId, Pair, ERC20Token } from '@tmyswap/sdk'
...
import { useWeb3LibraryContext } from '@tmyswap/wagmi'
...
export function toV2LiquidityToken([tokenA, tokenB]: [ERC20Token, ERC20Token]): ERC20Token {
  return new ERC20Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'TmySwap-LP', 'TmySwap LPs')
}
