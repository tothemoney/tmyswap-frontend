...
import { useModal, useToast, Farm as FarmUI } from '@tmyswap/uikit'
...
import { formatLpBalance } from '@tmyswap/utils/formatBalance'
import { ChainId, WNATIVE, NATIVE } from '@tmyswap/sdk'
