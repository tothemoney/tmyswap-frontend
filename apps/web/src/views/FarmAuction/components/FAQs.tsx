...
import { Text, Heading, Card, CardHeader, CardBody, Flex, Link, Box } from '@tmyswap/uikit'
            ...
            <FoldableText title={t('Step 1: Submit application')} mt="24px">
              <Box display="inline">
                <Text display="inline" color="textSubtle">
                  {t('Projects can submit an application to sponsor a yield farm and/or pool on TmySwap via the ')}
                </Text>
            ...
            <FoldableText title={t('Step 2: Await whitelisting')} mt="24px">
              <Box color="textSubtle">
                <Text color="textSubtle" mb="4px">
                  {t('The TmySwap team will try to respond within a week.')}
                </Text>
                <List>
                  <FaqLi>
                    {t(
