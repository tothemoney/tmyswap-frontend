...
import { TranslateFunction, useTranslation } from '@tmyswap/localization'
import { ChainId } from '@tmyswap/sdk'
import { bscTokens } from '@tmyswap/tokens'
import { InjectedModalProps, useToast } from '@tmyswap/uikit'
...
import { ethersToBigNumber } from '@tmyswap/utils/bigNumber'
