  ...
  return [
    {
      ...
      description: [
        t(
          'Trades are settled in WBNB, which is a wrapped version of BNB used on TMY Chain. That means that when you sell an item, WBNB is sent to your wallet instead of BNB.',
        ),
        t('You can instantly swap your WBNB for BNB with no trading fees on TmySwap.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.tmyswap.org/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by TmySwap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
