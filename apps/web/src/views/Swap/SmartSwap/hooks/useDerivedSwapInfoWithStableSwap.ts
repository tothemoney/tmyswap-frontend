import { Currency, CurrencyAmount, Pair, TradeType } from '@tmyswap/sdk'
import { StableSwapPair, TradeWithStableSwap } from '@tmyswap/smart-router/evm'
import { Field } from 'state/swap/actions'
import { useCurrencyBalances } from 'state/wallet/hooks'
import { useTranslation } from '@tmyswap/localization'
import tryParseAmount from '@tmyswap/utils/tryParseAmount'
import { useWeb3React } from '@tmyswap/wagmi'
