...
import { Button, AutoRenewIcon, Box, Flex, Message, MessageText, Text } from '@tmyswap/uikit'
import _noop from 'lodash/noop'
import { useTranslation } from '@tmyswap/localization'
import isUndefinedOrNull from '@tmyswap/utils/isUndefinedOrNull'
import { MAX_LOCK_DURATION } from 'config/constants/pools'
import BigNumber from 'bignumber.js'
import { getBalanceAmount, getDecimalAmount } from '@tmyswap/utils/formatBalance'
