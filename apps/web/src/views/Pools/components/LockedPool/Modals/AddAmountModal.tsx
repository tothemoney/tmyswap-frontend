...
import { Modal, Box, MessageText, Message, Checkbox, Flex, Text } from '@tmyswap/uikit'
...
import { getBalanceNumber, getDecimalAmount, getBalanceAmount } from '@tmyswap/utils/formatBalance'
