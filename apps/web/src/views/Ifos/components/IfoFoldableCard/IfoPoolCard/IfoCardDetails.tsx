...
import { Text, Flex, Box, Skeleton, TooltipText, useTooltip, IfoSkeletonCardDetails } from '@tmyswap/uikit'
import { PublicIfoData, WalletIfoData } from 'views/Ifos/types'
import { useTranslation } from '@tmyswap/localization'
import { Ifo, PoolIds } from 'config/constants/types'
import { BIG_ONE_HUNDRED } from '@tmyswap/utils/bigNumber'
import { getBalanceNumber, formatNumber } from '@tmyswap/utils/formatBalance'
import useBUSDPrice from 'hooks/useBUSDPrice'
import { DAY_IN_SECONDS } from '@tmyswap/utils/getTimePeriods'
