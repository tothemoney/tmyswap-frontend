...
import { Box, Flex, Text, Heading, Link, Image, useMatchBreakpoints } from '@tmyswap/uikit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.tmyswap.org/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.tmyswap.org/products/lottery/lottery-guide">
              {t('how to play the TmySwap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
